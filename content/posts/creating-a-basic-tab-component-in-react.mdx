...
First, let's chalk out an outline of our component.
    ...
    Tabs.propTypes = {
      activeTabDefault: PropTypes.oneOfType([
        PropTypes.string,
        PropTypes.number,
      ]).isRequired
    }
                  ...
                  {React.Children.map(child.props.children, (child) => {
                    if (React.isValidElement(child)) {
                      return React.cloneElement(child, { 
                        className: `${child.props?.className || ''} ${child.props.id === activeTab ? 'active' : ''}`,
                        onClick: () => {
    ...
    function Tabs({ children, activeTabDefault, variant, ...otherProps }) {
      ...
      return (
        <div className={`tab tab--${variant}`} {...otherProps}>
          {React.Children.map(children, (child) => {
            if(child.type.name === 'TabNav') { //Check below
              return (
...
<Glitch embedUrl="[https://glitch.com/embed/#](https://glitch.com/embed/# "https://glitch.com/embed/#") "[https://glitch.com/embed/#](https://glitch.com/embed/# "https://glitch.com/embed/#")")!/embed/chestnut-twisty-fog?path=src/styles/styles.css&previewSize=0" title="chestnut-twisty-fog on Glitch" allow="geolocation; microphone; camera; midi; encrypted-media; xr-spatial-tracking; fullscreen" />